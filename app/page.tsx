...
export default function Home() {
    ...
    return (
        <div className="flex w-screen h-screen overflow-hidden bg-gradient-to-tl from-[#000015]/50 via-[#001B44]/50 to-[#00030A]/50">
            <div className="hidden md:flex flex-shrink-0 h-full w-[250px] ml-3 py-3">
            ...
            <div className="flex-1 h-full ml-3 py-3 mr-3">
                <div className="w-full h-full overflow-hidden relative duration-700 border rounded-xl hover:bg-zinc-800/10 group md:gap-8 hover:border-zinc-400/50 border-zinc-600 ">
